import common_butterfly from "./img/common_butterfly.png";
import yellow_butterfly from "./img/yellow_butterfly.png";
import tiger_butterfly from "./img/tiger_butterfly.png";
import peacock_butterfly from "./img/peacock_butterfly.png";
import common_bluebottle from "./img/common_bluebottle.png";
import paper_kite_butterfly from "./img/paper_kite_butterfly.png";
import great_purple_emperor from "./img/great_purple_emperor.png";
import monarch_butterfly from "./img/monarch_butterfly.png";
import emperor_butterfly from "./img/emperor_butterfly.png";
import agrias_butterfly from "./img/agrias_butterfly.png";
import rajah_brookes_birdwing from "./img/rajah_brookes_birdwing.png";
import queen_alexandras_birdwing from "./img/queen_alexandras_birdwing.png";
import moth from "./img/moth.png";
import atlas_moth from "./img/atlas_moth.png";
import madagascan_sunset_moth from "./img/madagascan_sunset_moth.png";
import long_locust from "./img/long_locust.png";
import migratory_locust from "./img/migratory_locust.png";
import rice_grasshopper from "./img/rice_grasshopper.png";
import grasshopper from "./img/grasshopper.png";
import cricket from "./img/cricket.png";
import bell_cricket from "./img/bell_cricket.png";
import mantis from "./img/mantis.png";
import orchid_mantis from "./img/orchid_mantis.png";
import honeybee from "./img/honeybee.png";
import wasp from "./img/wasp.png";
import brown_cicada from "./img/brown_cicada.png";
import robust_cicada from "./img/robust_cicada.png";
import giant_cicada from "./img/giant_cicada.png";
import walker_cicada from "./img/walker_cicada.png";
import evening_cicada from "./img/evening_cicada.png";
import cicada_shell from "./img/cicada_shell.png";
import red_dragonfly from "./img/red_dragonfly.png";
import darner_dragonfly from "./img/darner_dragonfly.png";
import banded_dragonfly from "./img/banded_dragonfly.png";
import damselfly from "./img/damselfly.png";
import firefly from "./img/firefly.png";
import mole_cricket from "./img/mole_cricket.png";
import pondskater from "./img/pondskater.png";
import diving_beetle from "./img/diving_beetle.png";
import giant_water_bug from "./img/giant_water_bug.png";
import stinkbug from "./img/stinkbug.png";
import man_faced_stink_bug from "./img/man_faced_stink_bug.png";
import ladybug from "./img/ladybug.png";
import tiger_beetle from "./img/tiger_beetle.png";
import jewel_beetle from "./img/jewel_beetle.png";
import violin_beetle from "./img/violin_beetle.png";
import citrus_long_horned_beetle from "./img/citrus_long_horned_beetle.png";
import rosalia_batesi_beetle from "./img/rosalia_batesi_beetle.png";
import blue_weevil_beetle from "./img/blue_weevil_beetle.png";
import dung_beetle from "./img/dung_beetle.png";
import earth_boring_dung_beetle from "./img/earth_boring_dung_beetle.png";
import scarab_beetle from "./img/scarab_beetle.png";
import drone_beetle from "./img/drone_beetle.png";
import goliath_beetle from "./img/goliath_beetle.png";
import saw_stag from "./img/saw_stag.png";
import miyama_stag from "./img/miyama_stag.png";
import giant_stag from "./img/giant_stag.png";
import rainbow_stag from "./img/rainbow_stag.png";
import cyclommatus_stag from "./img/cyclommatus_stag.png";
import golden_stag from "./img/golden_stag.png";
import giraffe_stag from "./img/giraffe_stag.png";
import horned_dynastid from "./img/horned_dynastid.png";
import horned_atlas from "./img/horned_atlas.png";
import horned_elephant from "./img/horned_elephant.png";
import horned_hercules from "./img/horned_hercules.png";
import walking_stick from "./img/walking_stick.png";
import walking_leaf from "./img/walking_leaf.png";
import bagworm from "./img/bagworm.png";
import ant from "./img/ant.png";
import hermit_crab from "./img/hermit_crab.png";
import wharf_roach from "./img/wharf_roach.png";
...
import pill_bug from "./img/pill_bug.png";
import centipede from "./img/centipede.png";
import spider from "./img/spider.png";
import tarantula from "./img/tarantula.png";
import scorpion from "./img/scorpion.png";
import bitterling from "./img/bitterling.png";
import pale_chub from "./img/pale_chub.png";
import crucian_carp from "./img/crucian_carp.png";
import dace from "./img/dace.png";
import carp from "./img/carp.png";
import koi from "./img/koi.png";
import goldfish from "./img/goldfish.png";
import pop_eyed_goldfish from "./img/pop_eyed_goldfish.png";
import ranchu_goldfish from "./img/ranchu_goldfish.png";
import killifish from "./img/killifish.png";
import crawfish from "./img/crawfish.png";
import soft_shelled_turtle from "./img/soft_shelled_turtle.png";
import snapping_turtle from "./img/snapping_turtle.png";
import tadpole from "./img/tadpole.png";
import frog from "./img/frog.png";
import freshwater_goby from "./img/freshwater_goby.png";
import loach from "./img/loach.png";
import catfish from "./img/catfish.png";
import giant_snakehead from "./img/giant_snakehead.png";
import bluegill from "./img/bluegill.png";
import yellow_perch from "./img/yellow_perch.png";
import black_bass from "./img/black_bass.png";
import tilapia from "./img/tilapia.png";
import pike from "./img/pike.png";
import pond_smelt from "./img/pond_smelt.png";
import sweetfish from "./img/sweetfish.png";
import cherry_salmon from "./img/cherry_salmon.png";
import char from "./img/char.png";
import golden_trout from "./img/golden_trout.png";
import stringfish from "./img/stringfish.png";
import salmon from "./img/salmon.png";
import king_salmon from "./img/king_salmon.png";
import mitten_crab from "./img/mitten_crab.png";
import guppy from "./img/guppy.png";
import nibble_fish from "./img/nibble_fish.png";
import angelfish from "./img/angelfish.png";
import betta from "./img/betta.png";
import neon_tetra from "./img/neon_tetra.png";
import rainbowfish from "./img/rainbowfish.png";
import piranha from "./img/piranha.png";
import arowana from "./img/arowana.png";
import dorado from "./img/dorado.png";
import gar from "./img/gar.png";
import arapaima from "./img/arapaima.png";
import saddled_bichir from "./img/saddled_bichir.png";
import sturgeon from "./img/sturgeon.png";
import sea_butterfly from "./img/sea_butterfly.png";
import sea_horse from "./img/sea_horse.png";
import clown_fish from "./img/clown_fish.png";
import surgeonfish from "./img/surgeonfish.png";
import butterfly_fish from "./img/butterfly_fish.png";
import napoleonfish from "./img/napoleonfish.png";
import zebra_turkeyfish from "./img/zebra_turkeyfish.png";
import blowfish from "./img/blowfish.png";
import puffer_fish from "./img/puffer_fish.png";
import anchovy from "./img/anchovy.png";
import horse_mackerel from "./img/horse_mackerel.png";
import barred_knifejaw from "./img/barred_knifejaw.png";
import sea_bass from "./img/sea_bass.png";
import red_snapper from "./img/red_snapper.png";
import dab from "./img/dab.png";
import olive_flounder from "./img/olive_flounder.png";
import squid from "./img/squid.png";
import moray_eel from "./img/moray_eel.png";
import ribbon_eel from "./img/ribbon_eel.png";
import tuna from "./img/tuna.png";
import blue_marlin from "./img/blue_marlin.png";
import giant_trevally from "./img/giant_trevally.png";
import mahi_mahi from "./img/mahi_mahi.png";
import ocean_sunfish from "./img/ocean_sunfish.png";
import ray from "./img/ray.png";
import saw_shark from "./img/saw_shark.png";
import hammerhead_shark from "./img/hammerhead_shark.png";
import great_white_shark from "./img/great_white_shark.png";
import whale_shark from "./img/whale_shark.png";
import suckerfish from "./img/suckerfish.png";
import football_fish from "./img/football_fish.png";
...
import academic_painting from "./art_img/academic_painting.png";
import amazing_painting from "./art_img/amazing_painting.png";
...
import quaint_painting from "./art_img/quaint_painting.png";
import scary_painting from "./art_img/scary_painting.png";
import scenic_painting from "./art_img/scenic_painting.png";
import serene_painting from "./art_img/serene_painting.png";
import sinking_painting from "./art_img/sinking_painting.png";
import solemn_painting from "./art_img/solemn_painting.png";
import twinkling_painting from "./art_img/twinkling_painting.png";
import warm_painting from "./art_img/warm_painting.png";
import wild_painting_left_half from "./art_img/wild_painting_left_half.png";
import wild_painting_right_half from "./art_img/wild_painting_right_half.png";
import wistful_painting from "./art_img/wistful_painting.png";
import worthy_painting from "./art_img/worthy_painting.png";
import ancient_statue from "./art_img/ancient_statue.png";
import beautiful_statue from "./art_img/beautiful_statue.png";
import familiar_statue from "./art_img/familiar_statue.png";
import gallant_statue from "./art_img/gallant_statue.png";
import great_statue from "./art_img/great_statue.png";
import informative_statue from "./art_img/informative_statue.png";
import motherly_statue from "./art_img/motherly_statue.png";
import mystic_statue from "./art_img/mystic_statue.png";
import robust_statue from "./art_img/robust_statue.png";
import rock_head_statue from "./art_img/rock_head_statue.png";
...
export default {
  ...
  jewel_beetle,
  violin_beetle,
  citrus_long_horned_beetle,
  rosalia_batesi_beetle,
  blue_weevil_beetle,
  dung_beetle,
  earth_boring_dung_beetle,
  scarab_beetle,
  drone_beetle,
  goliath_beetle,
  saw_stag,
